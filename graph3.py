...
for i in NM:
    ...
    profit2B.append(Pb_1 * (1-na_1) + symmetric(alpha2, alpha1, 1-na_2, 1-na_1, i))

    temp2 = asymmetric(alpha1, alpha2, Pb_1, na_1, na_2, n, i) + symmetric(alpha2, alpha1, na_2, na_1, i)

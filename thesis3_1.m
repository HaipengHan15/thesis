...
syms alpha_a alpha_b k V_1 V_2 t1 t2 c1 c2 real
syms Pa_1 Pa_2 Pb_1 Pb_2 real
syms na_1 na_2 nb_1 nb_2 real
syms CS1 CS2 CS SW t real
V_1 = 0;
...
c1 = 0;
c2 = 0;
eq1 = alpha_a*na_2 - Pa_1 - t1*na_1 - (alpha_b*nb_2 - Pb_1 - t1*nb_1);
eq2 = na_1 + nb_1 - 1;
eq3 = (k-alpha_a)*na_1 - Pa_2 - t2*na_2 - ((k-alpha_b)*nb_1 - Pb_2 - t2*nb_2);
eq4 = na_2 + nb_2 - 1;
sol1 = solve(eq1, eq2, eq3, eq4, na_1, na_2, nb_1, nb_2);
na_1 = sol1.na_1;
na_2 = sol1.na_2;
...
eq7 = simplify(subs(diff(pi_B, Pb_1)));
eq8 = simplify(subs(diff(pi_B, Pb_2)));
eq9 = simplify(subs(diff(pi_A, alpha_a)));
eq10 = simplify(subs(diff(pi_B, alpha_b)));
sol2 = solve(eq5, eq6, eq7, eq8, eq9, eq10, Pa_1, Pa_2, Pb_1, Pb_2, alpha_a, alpha_b);
Pa_1 = sol2.Pa_1;
Pa_2 = sol2.Pa_2;
Pb_1 = sol2.Pb_1;
Pb_2 = sol2.Pb_2;
alpha_a = sol2.alpha_a;
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 2
% the subcase that Pa_1 = Pb_1 = 0
% Pa_1 = 0;
% Pb_1 = 0;

...
eq3 = alpha2*na_1 - Pa_2 - t2*na_2 ;
eq4 = alpha2*nb_1 - Pb_2 - t2*nb_2;
...
% t1 = 1;
% t2 = 1;
% temp = 1 - (alpha1+alpha2)/2;
% temp1 = 1/2 - ((alpha1+alpha2)^2)/16 - (alpha1*alpha2)/4;
% sol1 = solve(temp-temp1, alpha2, 'ReturnConditions', true);
% alpha2 = sol1.alpha2;